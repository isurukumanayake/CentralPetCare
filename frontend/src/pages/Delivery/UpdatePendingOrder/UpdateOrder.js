					...
					<div className="column-update-order">
						<section className="input-container-update-order">
							...
							<input
								...
								disabled
							/>
							<span className="order-validateErrors visible-non"></span>
						</section>
						<section className="input-container-update-order">
					...
					<div className="column-update-order">
						...
						<section className="input-container-update-order">
							...
							<input
								...
								name="shippingAmount"
							/>
							<span className={shippingAmountError ? `order-validateErrors` : `order-validateErrors visible-non`}>{shippingAmountError}</span>
						</section>
						<section className="input-container-update-order">
							<span className="input-title-update-order">
								Total Amount(Rs.)
							...
							<input
								...
								name="total"
							/>
							<span className={totalError ? `order-validateErrors` : `order-validateErrors visible-non`}>{totalError}</span>
						</section>
						<section className="input-container-update-order">
							...
							<span className={deliveryStatusError ? `order-validateErrors` : `order-validateErrors visible-non`}>{deliveryStatusError}</span>
						</section>
                        <section className="input-container-update-order">
							<span className="input-title-update-order">
							...
							<input
								...
								name="assignedDriver"
							/>
							<span className={assignedDriverError ? `order-validateErrors` : `order-validateErrors visible-non`}>{assignedDriverError}</span>
						</section>
