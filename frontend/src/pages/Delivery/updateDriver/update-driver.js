					...
					<div className="column-update-driver">
						<section className="input-container-update-driver">
							...
							<input
								...
								name="driverName"
							/>
							<span className={driverNameError ? `driver-validateErrors` : `driver-validateErrors visible-non`}>{driverNameError}</span>
						</section>
						<section className="input-container-update-driver">
							...
							<input
								...
								name="nicNumber"
							/>
							<span className={nicNumberError ? `driver-validateErrors` : `driver-validateErrors visible-non`}>{nicNumberError}</span>
						</section>
						<section className="input-container-update-driver">
							...
							<textarea
								...
								name="permAddress"
							></textarea>
							<span className={permAddressError ? `driver-validateErrors` : `driver-validateErrors visible-non`}>{permAddressError}</span>
						</section>
						<section className="input-container-update-driver">
							<span className="input-title-update-driver">
								telephone number
							...
							<input
								...
								name="phoneNum"
							/>
							<span className={phoneNumError ? `driver-validateErrors` : `driver-validateErrors visible-non`}>{phoneNumError}</span>
						</section>
					</div>
					{/* column lane two */}
					<div className="column-update-driver">
						<section className="input-container-update-driver">
							...
							/>
							<span className={driversLicenceNoError ? `driver-validateErrors` : `driver-validateErrors visible-non`}>{driversLicenceNoError}</span>
						</section>
						<section className="input-container-update-driver">
							<span className="input-title-update-driver">
							...
							<input
								...
								name="vehicleRegNo"
							/>
							<span className={vehicleRegNoError ? `driver-validateErrors` : `driver-validateErrors visible-non`}>{vehicleRegNoError}</span>
						</section>
						<section className="input-container-update-driver">
							...
							<span className={vehicleTypeError ? `driver-validateErrors` : `driver-validateErrors visible-non`}>{vehicleTypeError}</span>
						</section>
                        <section className="input-container-update-driver">
